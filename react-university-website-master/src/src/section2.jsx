...
import AIlabnews from './AIlabnews.jpg';
import river from './river.jpg';
import coin from './coin.jpg';
import NECHE from './NECHE.jpg';
import twogirls from './two_girls.jpg';
    ...
    <div>
      ...
      <div className="section2_container">
        <div className="section2_container1">
          <img src={AIlabnews} style={{ width: '250%', height: '530px' }} />
        ...
        <div className="section2_container2">
          <img src={river} style={{ width: '100%', height: '530px' }} />
        ...
        <div className="section2_container3">
          <img src={coin} style={{ width: '100%', height: '530px' }} />
      ...
      <div className="section3_container">
        ...
        <div className="section3_container2">
          <img src={NECHE} alt="ek_ldka_do_ldki" />
        </div>
      </div>
      ...
      <div className="section4_container">
        ...
        <br />
        <center><img src={twogirls} /></center>
      </div>
