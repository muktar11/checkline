...
import bhalu from './bhalu.jpg';
import seaman from './seaman.jpg';
      ...
      <div className="section9_container">
        <div className="section9_container1">
          <div className="section9_container1_part1">
            <center><img style={{ height: '70px', width: '90px', marginTop: '90px' }} src={mark} alt="logo" /></center>
            <br />
          ...
          <div className="section9_container1_part2">
            <img src={mam} style={{ height: '380px', width: '85%' }} alt="mam" />
          </div>
        </div>
      </div>
    </div>
